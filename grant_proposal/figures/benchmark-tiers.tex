...
% ============ TIER 3 ============
\node[tierbox=t3col, right=0.6cm of t2] (t3) {
...
% ============ TIER 4 ============
\node[tierbox=t4col, right=0.6cm of t3] (t4) {
...
\node[wpbadge=wpyellow, anchor=north east] at (t4.north east) {WP3};
...
\draw[decorate, decoration={brace, amplitude=6pt, mirror, raise=6pt}, thick, color=arrcol]
  (t1.south west) -- (t4.south east)
  node[midway, below=14pt, font=\small\sffamily, color=arrcol] {
    Increasing sequence length, task complexity, and ecological validity $\longrightarrow$
  };

% ============ TOP: Decision gate ============
\node[above=0.8cm of $(t2.north)!0.5!(t3.north)$, font=\scriptsize\sffamily\itshape, color=arrcol,
