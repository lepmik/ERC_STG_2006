...
\begin{tikzpicture}[
    ...
    resultbox/.style={draw, rounded corners=3pt, minimum height=0.4cm,
                      font=\tiny\sffamily\bfseries, fill=#1!20, draw=#1!50, text=#1!80},
...
% Feedback arrows
\draw[darr=wp1col, <-] (pam.170) -- ++(-0.8,0) |- node[below, label, xshift=8pt] {Design rules} (wp1.east |- wp1.south east);
\draw[darr=wp2col, <-] (pam.10) -- ++(0.8,0) |- node[below, label, xshift=-8pt] {Compositions} (wp2.west |- wp2.south west);
