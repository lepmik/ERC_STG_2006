...
\noindent\textbf{ML systems engineering:} The PAM and PAMNCA codebases demonstrate large-scale ML engineering: systematic GPU cluster experiments ($\sim$15K GPU-hours on A40s), automated result parsing from 150+ log files, reproducible evaluation pipelines, and benchmarking across 5 real-world domains (CORe50, MIT-BIH, ESC-50, VoxCeleb, embodied navigation) using official online continual learning protocols. The postdoc will be recruited from the ML systems community (target: PhD from ICLR/ICML-publishing lab) to complement the PI's neuroscience background.
...
\noindent\textbf{Contributions to research infrastructure}: Co-developed NEST simulator modules (Human Brain Project); co-developed Exdir data format and Expipe data management platform; lead role establishing NeuroAI as focus field in Norway--US Ministry of Education collaboration (2022). Developed NeuroAI course at University of Oslo (2023).
