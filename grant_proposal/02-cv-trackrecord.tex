...
\noindent I have published 20 peer-reviewed articles (h-index 10, 727 citations, i10-index 11; Google Scholar, 2026), including in \textbf{NeurIPS}, \textbf{Nature Communications}, \textbf{Science Advances}, and \textbf{eLife}, with 5 preprints under review.

\noindent\textbf{Scientific independence.} Since 2020 I have led the BioAI group at Simula, recognised as a research leader through competitive internal group funding, and am senior or corresponding author on six of the ten outputs above. I have supervised 2 PhD students to completion and 4 in progress, and four MSc students have continued to PhD studies at Simula, the University of Oslo, and Stanford. I have raised or co-raised funding as work-package co-lead of the \textbf{SURE-AI} national AI centre (RCN) and \textbf{SPARK} (RCN), and as co-PI on RCN projects.

\noindent\textbf{Signature contributions.}
\begin{itemize}[noitemsep,topsep=2pt]
  \item \textit{Cognitive maps in artificial agents} --- my group is world-leading on AI models of spatial navigation: grid, place, border, and toroidal cells emerge spontaneously in trained agents, and context is encoded by orthogonal remapping (iScience 2023, 17 cit.; eLife 2025; NeurIPS 2024; PLOS Comput.\ Biol.\ 2025).
  \item \textit{Causal inference for neural circuits} --- with K.\ Kording I developed quasi-experimental methods that led directly to the first full mapping of the fruit-fly brain effectome (Pospisil et al., \textit{Nature} 2024); PLOS Comput.\ Biol.\ 2023 (20 cit.).
  \item \textit{Experimental neuroscience} --- optogenetic causal evidence for temporal coding in grid cells (\textit{Science Advances} 2021, 21 cit.) and perineuronal-net stabilisation of the grid-cell network (\textit{Nature Communications} 2021, 72 cit., co-first).
  \item \textit{Neuro-inspired AI (the PAM line)} --- neural cellular automata for inter-module communication and one-shot memory transfer (ARC-NCA, featured on Machine Learning Street Talk; EngramNCA), and the memory architecture underpinning FIND.
\end{itemize}

\noindent\textbf{Qualification for FIND.} My multidisciplinary profile---experimental neuroscience, machine learning, and large-scale research software---together with a track record of building an independent group and delivering FIND's preliminary results, positions me to lead the project's integration of neurocomputational principles and modern machine learning.
